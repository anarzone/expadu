...
function Sidebar({
  ...
  if (isMobile) {
    // Mobile navigation is handled by MobileDock + MoreMenu — no sidebar sheet
    return null
  }
  ...
  return (
    <div
      ...
      data-slot="sidebar"
    >
      {/* Single sticky sidebar — no spacer/fixed desync.
          Matches prototype: sticky, in document flow, smooth width transition. */}
      <nav
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {isMobile || state === "collapsed" ? <IconLayoutSidebarLeftExpand /> : <IconLayoutSidebarLeftCollapse />}
