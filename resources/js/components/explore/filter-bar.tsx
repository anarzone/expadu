...
const filters: Array<{ id: string; label: string; icon: ComponentType<any> }> =
    [
        ...
        { id: 'restaurant', label: 'Restaurants', icon: IconToolsKitchen2 },
        { id: 'fast_food', label: 'Fast Food', icon: IconBurger },
        { id: 'bar', label: 'Bars', icon: IconGlass },
        { id: 'bakery', label: 'Bakeries', icon: IconBread },
            ...
            {filters.map((f) => {
                ...
                return (
                    <button
                        ...
                        className={`flex shrink-0 items-center gap-[5px] rounded-full border px-3 py-1.5 text-xs font-medium whitespace-nowrap transition-all ${
                            active === f.id
