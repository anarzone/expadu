...
export function ProfileRightPanel({
    ...
    return (
        <>
            ...
            <div className="mb-3.5 overflow-hidden rounded-[14px] border border-[#E2DFD6] bg-white">
                ...
                >
                    ...
                    <div className="min-w-0 flex-1">
                        <div style={{ fontSize: 12, fontWeight: 600, marginBottom: 1 }}>My upcoming events</div>
                        <div style={{ fontSize: 11, color: '#6B6860' }}>2 events this week</div>
                    </div>
                </div>
                <div
                    className="flex cursor-pointer items-start gap-2.5 border-b border-[#E2DFD6] px-[15px] py-[11px] transition-colors hover:bg-[#EFEDE7]"
                ...
                >
                    <span className="mt-px shrink-0" style={{ fontSize: 16 }}>🗣️</span>
                    <div className="min-w-0 flex-1">
                        <div style={{ fontSize: 12, fontWeight: 600, marginBottom: 1 }}>Language partners</div>
                        <div style={{ fontSize: 11, color: '#6B6860' }}>1 pending request</div>
                    </div>
                </div>
                <div
                ...
                >
                    <span className="mt-px shrink-0" style={{ fontSize: 16 }}>⚙️</span>
                    <div className="min-w-0 flex-1">
                        <div style={{ fontSize: 12, fontWeight: 600, marginBottom: 1 }}>Settings</div>
                        <div style={{ fontSize: 11, color: '#6B6860' }}>Notifications, privacy</div>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-3.5 overflow-hidden rounded-[14px] border border-[#E2DFD6] bg-white">
                <div className="border-b border-[#E2DFD6] px-[15px] py-3">
                    <span style={{ fontSize: 13, fontWeight: 700 }}>Expadu Premium</span>
                </div>
                <div className="px-[15px] py-3.5">
                    <div style={{ fontSize: 13, color: '#6B6860', lineHeight: 1.5, marginBottom: 10 }}>
                        Unlock instant Bürgeramt slot alerts, priority partner matching, and ad-free experience.
                    </div>
                    <button
