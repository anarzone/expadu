        ...
        <div>
            {cards.map((card, index) => {
                switch (card.type) {
                    case 'blue_highlight':
                        return (
                            <FeedSection key={index}>
                                <BlueHighlightCard
                                    data={
                                        card.data as unknown as BlueHighlightData
                                    }
                                />
                            </FeedSection>
                        );
                    case 'disruption_banner':
                        return (
                            <FeedSection key={index}>
                                <DisruptionBanner
                                    data={
                                        card.data as unknown as DisruptionBannerData
                                    }
                                />
                            </FeedSection>
                        );
                    case 'settlement_progress':
                        return (
                            <FeedSection key={index} label="Settlement">
                                <ProgressCard
                                    data={
                                        card.data as unknown as SettlementProgressData
                                    }
                                />
                            </FeedSection>
                        );
                    case 'your_places':
                        return (
                            <FeedSection key={index} label="Your Places">
                                <PlacesChips
                                    data={
                                        card.data as unknown as YourPlacesData
                                    }
                                />
                            </FeedSection>
                        );
                    case 'quick_access':
                        return (
                            <FeedSection key={index} label="Quick Access">
                                <QuickAccessGrid
                                    data={
                                        card.data as unknown as QuickAccessData
                                    }
                                />
                            </FeedSection>
                        );
                    case 'this_week':
                        if (
                            (card.data as { placeholder?: boolean }).placeholder
                        ) {
                            return (
