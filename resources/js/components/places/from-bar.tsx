...
/**
 * The shared "From" control: where distances are measured from (live location,
 * a saved place, a searched address, or a point tapped on the map) and how you
 * travel (Walk / Transit / Bike). Presentational — the page owns the state and
 * supplies the handlers, so Places and the Composer behave identically.
 */
export function FromBar({
    origin,
    mode,
    locating,
    savedPlaces,
