...
/**
 * The inner content of the area picker: "All Cologne / Near me" globals, the
 * Bezirk rail, then a drill into that Bezirk's Stadtteile. Rendered on its own
 * inside the composer's inline sentence-word popover, or wrapped by AreaPicker
 * (pill + popover) on Places. Presentational — the page owns the selection.
 */
...
/**
 * The full "Searching in {area} ▾" pill + popover (the Places toolbar form).
 * The composer uses AreaPickerPanel directly under its inline sentence word.
 */
export function AreaPicker({ areaLabel, open, onOpenChange, ...panel }: Props) {
    return (
