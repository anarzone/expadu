...
export function RoutePreviewMap({ origin, destination, mode, geometry }: RoutePreviewMapProps) {
        ...
        import('maplibre-gl').then((maplibregl) => {
            ...
            fetch('https://tiles.openfreemap.org/styles/bright')
                ...
                map.addLayer({
                    ...
                    paint: { 'line-color': color, 'line-width': 6, 'line-opacity': 0.2 },
                });
                ...
                originEl.style.cssText = 'display:flex;align-items:center;justify-content:center;width:32px;height:32px;border-radius:50%;background:#0A7C52;box-shadow:0 2px 8px rgba(0,0,0,0.25);font-size:16px;line-height:1;';
                ...
                destEl.style.cssText = 'display:flex;align-items:center;justify-content:center;width:32px;height:32px;border-radius:50%;background:#C4271A;box-shadow:0 2px 8px rgba(0,0,0,0.25);font-size:16px;line-height:1;';
                destEl.textContent = '\uD83C\uDFC1';
                ...
                map.fitBounds(bounds, { padding: { top: 40, bottom: 40, left: 40, right: 40 }, maxZoom: 15, duration: 500 });
            });
        });
        });
    ...
    }, [origin.lat, origin.lng, destination.lat, destination.lng, mode, geometry]);

    return (
        <div
            ref={containerRef}
            style={{ width: '100%', height: 220, borderRadius: 14, border: '1px solid #E2DFD6', overflow: 'hidden' }}
        />
    );
}
