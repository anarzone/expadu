...
enum TicketAdvice: string
{
    ...
    {
        return match ($this) {
            self::DeutschlandTicket => 'Flat €63/month for all local transit in Germany — almost always worth it if you ride more than twice a week.',
            self::SemesterTicket => 'Your enrolment usually includes an NRW-wide Semesterticket — check before buying anything.',
            self::JobTicketAsk => 'Many employers subsidise the Deutschlandticket as a JobTicket (~€45) — ask HR before paying the full €63.',
